...
function init() {
    ...
    loader.load('https://threejs.org/examples/models/obj/walt/WaltHead.obj', obj => {
        object = obj;
    ...
    light1.add(new THREE.Mesh(sphereGeometry, new THREE.MeshBasicMaterial({ color: 0xff0040 })));
    scene.add(light1);

    light2 = new THREE.PointLight(0x0040ff, 2, 50);
    light2.add(new THREE.Mesh(sphereGeometry, new THREE.MeshBasicMaterial({ color: 0x0040ff })));
    scene.add(light2);

    light3 = new THREE.PointLight(0x80ff80, 2, 50);
    light3.add(new THREE.Mesh(sphereGeometry, new THREE.MeshBasicMaterial({ color: 0x80ff80 })));
    scene.add(light3);

    light4 = new THREE.PointLight(0xffaa00, 2, 50);
    light4.add(new THREE.Mesh(sphereGeometry, new THREE.MeshBasicMaterial({ color: 0xffaa00 })));
    scene.add(light4);
