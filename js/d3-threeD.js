 ...
 */
function d3threeD(exports, THREE) {
    const DEGS_TO_RADS = Math.PI / 180;
    const DIGIT_0 = 48; const DIGIT_9 = 57; const COMMA = 44; const SPACE = 32; const PERIOD = 46; const MINUS = 45;

    exports.transformSVGPath = function transformSVGPath(pathStr) {
        const path = new THREE.ShapePath();

        let idx = 1; let activeCmd;
        let x = 0; let y = 0; let nx = 0; let ny = 0; let firstX = null; let firstY = null;
        let x1 = 0; let x2 = 0; let y1 = 0; let y2 = 0;
        let rx = 0; let ry = 0; let xar = 0; let laf = 0; let sf = 0; let cx; let cy;

        const len = pathStr.length;

        function eatNum() {
            let sidx; let c; let isFloat = false; let s;
